...
Commentaire: Oui, la variable suit une distribution normale
...
Commentaire: Le pourcentage de femmes ayant un infarctus et qui ont pris des contraceptifs oraux est de 33,18486 %.
Le pourcentage de femmes n'ayant pas d'infarctus et qui ont pris des contraceptifs oraux est de 66,81514 %.
...
```
 ...
 Commentaire:La probabilité d'avoir un infarctus du myocarde est de 44,54343 %.
...
```
 ...
 Commentaire: La variable est discrète.
...
Commentaire: Oui
 ...
 7. Est-ce que la consommation du tabac est un facteur de risque chez le femmes ayant eu un infarctus du myocarde?
...
Commentaire: Oui, car on constate que les femmes ayant une consommation de tabas ont un taux d'infarctus plus élevé.
...
```
  ...
  Commentaire: Oui, on constate que nos deux résultats sont différents.
...
```
  ...
  Commentaire:Oui , les résultats sont bien différents.